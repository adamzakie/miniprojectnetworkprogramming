  ...
  🚀 Features
1. Multi-Client Support: Handles multiple users simultaneously using multithreading.

2. AES Encryption: All messages are encrypted using AES before transmission to ensure secure communication.

3. Authentication: Implements a password handshake mechanism to verify clients upon connection.
...
3. Connect: In each ChatUI window, click the "Connect & Start" button.
...
AHMAD SHADZARIL IKHWAN BIN ABDUL RAHMAN	   241301780

HASHRY AFIQ BIN ALIYAZIM	                 241302492

MUHAMMAD AQIL BIN NORASLY	                 241302499
